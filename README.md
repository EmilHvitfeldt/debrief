...
#> [!!!] GC consuming 35.0% of time (350 ms)
#> High garbage collection overhead. Look for growing vectors,
#> repeated data frame operations, or unnecessary copies.

# Get actionable optimization suggestions
pv_print_suggestions(p)
#> === Priority 1 ===
#>
#> [hot line] R/analysis.R:42
#>     Line 'result <- rbind(result, row)' consumes 25% of time.
